...
<div class="dnbooking dnbooking_api">
	<form action="<?php echo Route::_('index.php?option=com_vmmapicon&layout=' . $layout . $tmpl . '&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
        ...
        <div class="main-card">
            ...
            <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'details', empty($this->item->id) ? Text::_('COM_VMMAPICON_NEW_API') : Text::_('COM_VMMAPICON_EDIT_API')); ?>
            <div class="row">
                <div class="col-lg-9">
                    <?php echo $this->form->renderFieldset('apiParams'); ?>
                </div>
                <div class="col-lg-3">
